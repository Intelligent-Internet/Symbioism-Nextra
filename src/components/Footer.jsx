      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex items-start justify-start md:justify-end space-x-4">
            <a href="https://x.com/EMostaque" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400"><Twitter size={20} /></a>
            <a href="https://www.youtube.com/@ii_posts/videos" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400"><Youtube size={20} /></a>
            <a href="https://github.com/Intelligent-Internet/Symbioism-Nextra" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400"><Github size={20} /></a>
            <a href="https://discord.gg/VBD2yybb" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-400">
