...
<audio controls className="w-full mt-6">
  <source
    src="https://storage.googleapis.com/webstatics.ii.inc/Chapter-3-TLE.mp3"
    type="audio/mp3"
  />
</audio>
...
**The Myth:** Economic growth means making more physical stuff using more physical resources. To grow, a nation must consume more of the planet.

**Output = f(Capital, Labor, Resources)**

This production function, we are told, is a law of nature.
