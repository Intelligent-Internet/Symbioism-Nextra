...
<audio controls className="w-full mt-6">
  <source src="https://webstatics.ii.inc/Chapter-4-TLE.mp3" type="audio/mp3" />
</audio>
...
**Exhibit B: The Cancer Boom.** A healthy person contributes little to the healthcare economy. But a person diagnosed with lung cancer? That is a windfall for GDP. Consider the grim transactions that follow the tragedy:

- Diagnostic tests ($10,000)
- Surgery ($100,000)
- Chemotherapy ($150,000)
- Hospitalstays ($75,000)
- Medications ($40,000)

A single cancer case can generate a $425,000 gain in GDP.
